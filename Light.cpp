...
//        GLfloat spot_direction[] = { -1.0, -1.0, 0.0 };
        glLightf(GL_LIGHT0 + bindID, GL_SPOT_CUTOFF, Globals::spotlight.angle);
        glLightf(GL_LIGHT0 + bindID, GL_SPOT_EXPONENT, Globals::spotlight.exp);
        glLightfv(GL_LIGHT0 + bindID, GL_SPOT_DIRECTION, Globals::spotlight.direction.ptr());
    }
    glPopMatrix();
    glFlush();
}
